...
def write_version_info():
    ...
    if os.getenv("TCIA_DOWNLOADER_BUILD_VERSION"):
        version = os.getenv("TCIA_DOWNLOADER_BUILD_VERSION")
    elif sha != "Unknown":
        version += "+" + sha[:7]

    version_path = os.path.join(cwd, "tcia_downloader", "version.py")
...
def install(version):
    setup(
        ...
        license="Apache",
        url="https://github.com/TidalPaladin/tcia_downloader",
